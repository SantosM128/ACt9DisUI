...
import 'package:santos0415/data/category_model.dart';
import 'package:santos0415/data/plant_data.dart';
import 'package:santos0415/page/details_page.dart';
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: const DecorationImage(
                image: AssetImage('assets/images/petcoLogo.png'),
              ),
            ),
          ),
        ],
              ...
              child: Row(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: white,
                      border: Border.all(color: Color(0xff002881)),
                      boxShadow: [
                        BoxShadow(
                          color: lightGreen.withOpacity(0.2),
                          blurRadius: 10,
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            ...
                            style: TextStyle(
                              color:
                                  selectId == i ? red : black.withOpacity(0.7),
                              fontSize: 16.0,
                            ),
                          ),
                          if (selectId == i)
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: Color(0x33580000), width: 2),
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              top: 8,
              child: CircleAvatar(
                backgroundColor: Color(0xff1163e0),
                radius: 8,
                child: Image.asset(
                  'assets/icons/mas.png',
                  color: white,
